...
public class Normalizer {
	...
	private static Redwood.RedwoodChannels log = Redwood.channels(Normalizer.class);

	public static Map<String, String> presToLogicalMap() {
		Map<String, String> rules = Generics.newHashMap();

		// PRESENTATION FORM TO LOGICAL FORM NORMALIZATION (presentation form is rarely
		// used - but some UN documents have it).
	...
	public static Map<String, String> getArabicIBMNormalizerMap() {
		...
		try {
			rules.put("[\\u0622\\u0623\\u0625]", "\u0627"); // hamza normalization: maddah-n-alef, hamza-on-alef,
															// hamza-under-alef mapped to bare alef

			rules.put("[\\u0649]", "\u064A"); // 'alif maqSuura mapped to yaa

			rules.put("[\\u064B\\u064C\\u064D\\u064E\\u064F\\u0650\\u0651\\u0652\\u0653\\u0670]", ""); // fatHatayn,
																										// Dammatayn,
																										// kasratayn,
																										// fatHa, Damma,
																										// kasra,
	...
	/**
	 * This will normalize a Unicode String by applying all the normalization rules
	 * from the IBM normalization and conversion from Presentation to Logical from.
	 *
	 *
	 * @param in
